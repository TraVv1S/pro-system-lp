  ...
  return (
    ...
    <div className={classes.advantages} id="advantages">
        <div className={classes.main}>
          ...
          <p className={classes.desc}> За более чем 10 лет работы мы познали все тонкости реализации проектов: как эффективно организовывать работу и обеспечивать качественный результат.</p>
        </div>
        ...
        <div className={classes.advantageItem}>
          ...
          <div className={classes.content}>
            ...
            <p>гарантируем подлинность поставляемой продукции</p>
          </div>
        </div>
        <div className={classes.advantageItem}>
          <h3>Квалифицированные специалисты</h3>
          <p>в области обслуживания оргтехники, имеющие соответствующие сертификаты</p>
        </div>
        <div className={classes.advantageItem}>
          <h3>Сертифицированное оборудование</h3>
          <p>оказываем услуги на оборудовании Static Control</p>
        </div>
